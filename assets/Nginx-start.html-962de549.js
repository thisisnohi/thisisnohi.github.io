import{_ as i,M as l,p as t,q as r,R as n,t as e,N as d,a1 as s}from"./framework-613df08c.js";const c={},p=s('<h1 id="nginx-note" tabindex="-1"><a class="header-anchor" href="#nginx-note" aria-hidden="true">#</a> Nginx-NOTE</h1><blockquote><p>参考：https://www.bilibili.com/video/BV1yS4y1N76R?p=7&amp;vd_source=9004ce053a52d5930f71e230579961e7</p><p>Nginx中文文档: https://blog.redis.com.cn/doc/</p></blockquote><h2 id="_1-版本" tabindex="-1"><a class="header-anchor" href="#_1-版本" aria-hidden="true">#</a> 1 版本</h2><ul><li>Nginx</li><li>Nginx plus 商用收费 https://www.nginx-cn.net/products/nginx/</li><li>openresty:https://openresty.org/cn/</li><li>Tengin:http://tengine.taobao.org/documentation_cn.html</li></ul><h2 id="_2-nginx-编译及使用" tabindex="-1"><a class="header-anchor" href="#_2-nginx-编译及使用" aria-hidden="true">#</a> 2 Nginx 编译及使用</h2>',5),o=n("li",null,"下载：https://nginx.org/en/download.html",-1),u={href:"https://www.bilibili.com/video/BV1yS4y1N76R/?p=7&spm_id_from=333.1007.top_right_bar_window_history.content.click&vd_source=9004ce053a52d5930f71e230579961e7",target:"_blank",rel:"noopener noreferrer"},v=s(`<h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><ul><li><p><code> ./configure --prefix=/usr/local/nginx</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>./configure <span class="token parameter variable">--prefix</span><span class="token operator">=</span>/usr/local/nginx --with-http_stub_status_module --with-http_ssl_module --with-stream<span class="token operator">=</span>dynamic --add-module<span class="token operator">=</span>./nginx-rtmp-module

-- rtmp模块
<span class="token number">1</span>. <span class="token function">git</span> clone https://github.com/arut/nginx-rtmp-module.git
<span class="token number">2</span>. ./configure命令添加 --add-module<span class="token operator">=</span>./nginx-rtmp-module
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><code>make </code></p></li><li><p><code>make install</code></p></li></ul><h3 id="启停nginx" tabindex="-1"><a class="header-anchor" href="#启停nginx" aria-hidden="true">#</a> 启停Nginx</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>cd /usr/local/nginx/sbin
启动: ./nginx
快速停止: ./nginx -s stop
优雅关闭: ./nginx -s quit
验证配置文件: ./nginx -t
