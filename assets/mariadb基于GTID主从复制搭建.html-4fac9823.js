import{_ as e,p as a,q as i,a1 as n}from"./framework-613df08c.js";const d={},s=n(`<h1 id="mariadb基于gtid主从复制搭建" tabindex="-1"><a class="header-anchor" href="#mariadb基于gtid主从复制搭建" aria-hidden="true">#</a> mariadb基于GTID主从复制搭建</h1><div align="center"><a href="https://github.com/alphayu/adnc" target="_blank" title="Adnc是一个微服务开发框架 代码改变世界 开源推动社区"><img src="https://aspdotnetcore.net/wp-content/uploads/2020/12/adnc-homepage-logo-3.webp" alt="Adnc是一个微服务开发框架 代码改变世界 开源推动社区"></a></div><p>本文演示环境是在同一台服务器上部署。因为docker创建容器时默认采用bridge网络，会自行分配ip，不允许指定，重启容器会导致ip变更。所以我们需要创建自定义的bridge网络，这样创建容器的时候才能指定ip。</p><h3 id="创建自定义网络" tabindex="-1"><a class="header-anchor" href="#创建自定义网络" aria-hidden="true">#</a> 创建自定义网络</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#创建一个新的bridge网络adnc_net
