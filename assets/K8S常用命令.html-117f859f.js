import{_ as e,p as i,q as n,a1 as d}from"./framework-613df08c.js";const s={},l=d(`<h1 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h1><h2 id="k8s自动补全" tabindex="-1"><a class="header-anchor" href="#k8s自动补全" aria-hidden="true">#</a> k8s自动补全</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum -y install bash-completion
