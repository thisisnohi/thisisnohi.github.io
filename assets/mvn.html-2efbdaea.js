import{_ as e,p as i,q as l,a1 as n}from"./framework-613df08c.js";const s={},a=n(`<h1 id="maven" tabindex="-1"><a class="header-anchor" href="#maven" aria-hidden="true">#</a> MAVEN</h1><h2 id="跳过测试类" tabindex="-1"><a class="header-anchor" href="#跳过测试类" aria-hidden="true">#</a> 跳过测试类</h2><ul><li>-DskipTests，不执行测试用例，但编译测试用例类生成相应的class文件至target/test-classes下。</li><li>-Dmaven.test.skip=true，不执行测试用例，也不编译测试用例类。</li></ul><h2 id="生命周期-lifecycle" tabindex="-1"><a class="header-anchor" href="#生命周期-lifecycle" aria-hidden="true">#</a> 生命周期 lifecycle</h2><ul><li><p>default</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>validate
initialize
generate-sources
process-sources
generate-resources
