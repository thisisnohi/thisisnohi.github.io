import{_ as e,p as i,q as a,a1 as d}from"./framework-613df08c.js";const n={},s=d(`<h2 id="第11章-时间序列" tabindex="-1"><a class="header-anchor" href="#第11章-时间序列" aria-hidden="true">#</a> 第11章 时间序列</h2><h3 id="datetime" tabindex="-1"><a class="header-anchor" href="#datetime" aria-hidden="true">#</a> datetime</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>from datetime import datetime
now = datetime.now()
