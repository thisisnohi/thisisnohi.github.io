import{_ as e,p as a,q as i,a1 as n}from"./framework-613df08c.js";const t={},l=n(`<h1 id="java基础" tabindex="-1"><a class="header-anchor" href="#java基础" aria-hidden="true">#</a> Java基础</h1><h2 id="nio" tabindex="-1"><a class="header-anchor" href="#nio" aria-hidden="true">#</a> Nio</h2><blockquote><p>参考: http://ifeve.com/overview/</p></blockquote><h3 id="bytebuffer" tabindex="-1"><a class="header-anchor" href="#bytebuffer" aria-hidden="true">#</a> ByteBuffer</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>	RandomAccessFile aFile = new RandomAccessFile( file, &quot;rw&quot; );
