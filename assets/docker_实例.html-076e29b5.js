import{_ as e,p as a,q as i,a1 as n}from"./framework-613df08c.js";const l={},d=n(`<h1 id="docker-实例" tabindex="-1"><a class="header-anchor" href="#docker-实例" aria-hidden="true">#</a> docker_实例</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><h3 id="redis" tabindex="-1"><a class="header-anchor" href="#redis" aria-hidden="true">#</a> redis</h3><blockquote><p>https://baijiahao.baidu.com/s?id=1696572376871263000&amp;wfr=spider&amp;for=pc</p></blockquote><ul><li><p>docker run --name redis -p 6379:6379 -v $HOME/data/redis/data:/data -d redis redis-server --appendonly yes</p></li><li><p>增加映射</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>本地目录： /opt/redis/conf
