import{_ as i,p as e,q as n,a1 as l}from"./framework-613df08c.js";const s={},r=l(`<h1 id="加解密-rsa-加解密加签" tabindex="-1"><a class="header-anchor" href="#加解密-rsa-加解密加签" aria-hidden="true">#</a> 加解密/RSA_加解密加签</h1><h2 id="加解密加签验签过程" tabindex="-1"><a class="header-anchor" href="#加解密加签验签过程" aria-hidden="true">#</a> 加解密加签验签过程</h2><ul><li>加密、加签 <ul><li>对方公钥加密数据</li><li>本方私钥对加密后数据进行加签，得到加签数据</li></ul></li><li>验签、解密过程 <ul><li>获取对方传送加密数据、加签数据</li><li>用对方公钥对加签数据进行验签</li><li>用本方私钥对加密数据进行解密</li></ul></li></ul><h2 id="密钥及格式生成" tabindex="-1"><a class="header-anchor" href="#密钥及格式生成" aria-hidden="true">#</a> 密钥及格式生成</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>-- 生成私钥
